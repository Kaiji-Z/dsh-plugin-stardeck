...
export const enWarCopy: WarCopy = {
  ...
  "focusPage": {
    ...
    "talkingAnswerLabel": "Answer on board",
    "talkingAnswerPlaceholder": "Answer the staff question right here (Ctrl+Enter to send)",
    "talkingAnswerBtn": "Send to staff",
    "talkingAnswerSending": "Sending…",
    "talkingAnswerSent": "Delivered — staff is continuing",
...
export const enPlainCopy: WarCopy = {
  ...
  "focusPage": {
    ...
    "talkingEnterBtn": "Enter dialogue and answer",
    "talkingAnswerLabel": "Answer on board",
    "talkingAnswerPlaceholder": "Answer the Planning Agent right here (Ctrl+Enter to send)",
    "talkingAnswerBtn": "Send to the Planning Agent",
    "talkingAnswerSending": "Sending…",
    "talkingAnswerSent": "Delivered — the Planning Agent is continuing",
    "taskBrief": "Task spec",
    "taskAcceptance": "Acceptance criteria",
